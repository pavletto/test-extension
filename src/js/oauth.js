...
(function() {
    window.oauth2 = {
        ...
        client_id: "M0REQOH3D9QTVGA8NDO32KGDD25LRM8GJ9LSNDHQD0RDIKLBR5STDJ4RS7SSEPV5",
        client_secret: "VIQJQQ31FU4778CJ3GONC4L04ITCKSE1M8R98H2EKVF2PVRDGACMOUPJRK96SH2E",
        redirect_url: "https://hh.ru/",
        response_type : "code",
        scopes: [],
        ...
        start: function() {
            window.close();
            var url = this.authorization_url + "?response_type=" + this.response_type + "&client_id=" + this.client_id + "&redirect_uri=" + this.redirect_url + "&scopes=";
